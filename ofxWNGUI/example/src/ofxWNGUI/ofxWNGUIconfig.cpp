...
ofxWNGUIconfig::ofxWNGUIconfig(){
	...
	BUTTON_COLOR_G        = 160;
	BUTTON_COLOR_B        = 255;
	BUTTON_COLOR_OVER_R   = 0;
	BUTTON_COLOR_OVER_G   = 60;
	BUTTON_COLOR_OVER_B   = 255;
	BUTTON_COLOR_ACTIVE_R = 0;
	BUTTON_COLOR_ACTIVE_G = 60;
	BUTTON_COLOR_ACTIVE_B = 255;
	BUTTON_ALPHA          = 255;
	
	// checkbox
	CHECKBOX_SIZE           = 10;
	CHECKBOX_COLOR_R        = 0;
	CHECKBOX_COLOR_G        = 150;
	CHECKBOX_COLOR_B        = 255;
	//CHECKBOX_COLOR_OVER_R   = 0;
	//CHECKBOX_COLOR_OVER_G   = 60;
	//CHECKBOX_COLOR_OVER_B   = 255;
	CHECKBOX_COLOR_ACTIVE_R = 0;
	CHECKBOX_COLOR_ACTIVE_G = 60;
	CHECKBOX_COLOR_ACTIVE_B = 255;
	CHECKBOX_ALPHA          = 255;

...
void ofxWNGUIcheckbox::addListener() {
	//ofAddListener(ofEvents.draw, this, &ofxWNGUIcheckbox::draw);
...
void ofxWNGUIcheckbox::removeListener() {
	//ofRemoveListener(ofEvents.draw, this, &ofxWNGUIcheckbox::draw);
...
void ofxWNGUIcheckbox::display() {//ofEventArgs &args) {
	...
	ofFill();
	if(status == false) ofSetColor(CHECKBOX_COLOR_R, CHECKBOX_COLOR_G, CHECKBOX_COLOR_B, CHECKBOX_ALPHA);
	else ofSetColor(CHECKBOX_COLOR_ACTIVE_R, CHECKBOX_COLOR_ACTIVE_G, CHECKBOX_COLOR_ACTIVE_B, CHECKBOX_ALPHA);
